=== NFL Football Team Stats Lite ===
Contributors: bpmee31
Donate link: http://www.ibet.ws/get_stats.php
Tags: football, ncaa football, nfl, football stats, ncaaf, nfl football stats, nfl news, sports stats, stats football
...
NFL Team Stats plugin can be added to any blog with a dynamic sidebar. Once installed, the blogger can choose their favorite NFL Team. The stats are updated each week of the NFL regular season, so that blog 
visitors can keep track of all the important NFL team standings and stats. Additionally, teams qualifying for post-season play are denoted automatically in each stats table with the the standard NFL *, x,y or z symbols.
...
1. Upload `nfl-team-stats` folder to the `/wp-content/plugins/` directory
